...
class profile::query_service::monitor::wikidata_internal_scholarly {
    ...
    prometheus::blackbox::check::http { 'wdqs_internal_scholarly_sparql_endpoint_sre':
    ...
    prometheus::blackbox::check::http { 'wdqs_internal_scholarly_sparql_endpoint_search':
        server_name        => 'wdqs-internal-scholarly.discovery.wmnet',
        instance_label     => $facts['hostname'],
