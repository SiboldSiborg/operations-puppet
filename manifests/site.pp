...
node /^kubernetes10(2[5-9]|[3-5][0-9]|6[0-2]|)\.eqiad\./ {
...
node /^wikikube-worker10(0[1-9]|1[0-9]|2[0-9]|3[0-7])\.eqiad\./ {
    role(kubernetes::worker)
}
...
node /^wikikube-worker21([0-6][0-9]|7[0-5])\.codfw\./ {
    role(kubernetes::worker)
}
