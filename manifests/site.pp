...
node /^db2(136|140|147|172|179|206|210|219|237|240)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db22(26|28|31|32|33|34|35|36|39)\.codfw\./ {
    role(insetup::data_persistence)
}
...
node /^ganeti20(1[345])\.codfw\./ {
    role(insetup::infrastructure_foundations)
}

node /^ganeti20(1[6-9]|2[0-9]|3[01256789]|4[0-2])\.codfw\./ {
    role(ganeti)
}

# New Codfw  Ganeti nodes
node /^ganeti20(4[3-4])\.codfw\./ {
    role(insetup::infrastructure_foundations)
}
