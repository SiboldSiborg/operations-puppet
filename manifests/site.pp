...
node /^db1(159|183|185|200|210|230)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^kubernetes10(4[7-9]|5[0-9]|6[0-2]|)\.eqiad\./ {
...
node /^wikikube-worker10(0[1-9]|[1-6][0-9]|7[0-1])\.eqiad\./ {
    role(kubernetes::worker)
}
...
node /^wikikube-worker21([0-6][0-9]|7[0-9])\.codfw\./ {
    role(kubernetes::worker)
}
