...
node /^ganeti10(09|1[1256789]|2[0-9]|3[0-9]|4[0-9]|5[0])\.eqiad\./ {
    role(ganeti)
}

# Old servers, to be decommed
node /^ganeti10(1[034])\.eqiad\./ {
    role(insetup::infrastructure_foundations)
}

node /^ganeti10(5[1-2]|)\.eqiad\./ {
    role(insetup::infrastructure_foundations)
}
...
node /^ganeti20(1[7-9]|2[0-9]|3[01256789]|4[0-4])\.codfw\./ {
    role(ganeti)
}
...
node /^wikikube-worker21(0[0-9]|1[0-9]|2[0-7])\.codfw\./ {
    role(kubernetes::worker)
}

# T376170 T376172
node /^wikikube-worker21(2[8-9]|3[0-9]|4[0-9]|5[0-5])\.codfw\./ {
    role(insetup::serviceops)
}
